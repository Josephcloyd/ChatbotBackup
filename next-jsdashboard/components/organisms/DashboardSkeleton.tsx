        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="metric-card">
            ...
            <div style={{ flex: 1 }}>
              <Skeleton
                className="mb-2"
                style={{ width: "60px", height: "10px", borderRadius: "3px" }}
              />
              <Skeleton
        ...
        <article className="chart-card">
          <div className="card-heading">
            <div>
              <Skeleton
                className="mb-2"
                style={{ width: "100px", height: "12px", borderRadius: "3px" }}
              />
              <Skeleton
                style={{ width: "160px", height: "20px", borderRadius: "4px" }}
              />
            </div>
            <Skeleton
        ...
        <article className="assumptions-card">
          <div className="card-heading">
            <div>
              ...
              />
              <Skeleton
                style={{ width: "130px", height: "20px", borderRadius: "4px" }}
              />
            </div>
          </div>
