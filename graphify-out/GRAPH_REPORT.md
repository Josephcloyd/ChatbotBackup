...
2. `buildDynamicPlan()` - 33 edges
3. `createApp()` - 31 edges
...
Cohesion: 0.09
Nodes (31): copyRowFormatting(), ExcelService, rowIsAvailable(), ProductionPromptInput, PromptService, promptTemplate(), todayIso(), detectHeaderRow() (+23 more)
...
Cohesion: 0.29
Nodes (10): AdminPlanDetailsPanel(), AdminPlanDetailsPanelProps, display(), editableValue(), fileSize(), safeList(), PlanTable(), PlanTableProps (+2 more)
