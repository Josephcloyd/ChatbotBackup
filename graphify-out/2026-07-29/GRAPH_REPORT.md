...
## Corpus Check
- 122 files · ~87,274 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 862 nodes · 1691 edges · 51 communities (44 shown, 7 thin omitted)
...
Cohesion: 0.09
Nodes (46): addDays(), collectDate(), DATE_EXPRESSION, DateInterpretation, endOfMonth(), extractNormalizedDateConstraints(), formatIsoDate(), isIsoDate() (+38 more)

### Community 1 - "planWorkspaceService.ts"
Cohesion: 0.11
Nodes (36): addChange(), applyChangesToSettings(), applyDefaultPlanningModel(), ApplyPlanProposalInput, applyProposalToPlanData(), baseSettingsFromPlan(), buildAssistantResponse(), buildPlanChangeProposal() (+28 more)
...
### Community 5 - "plannerService.ts"
Cohesion: 0.06
Nodes (55): AppConfig, config, loadConfig(), positiveNumber(), extractOllamaText(), generateWithOllama(), getAvailableOllamaModel(), OllamaResponse (+47 more)

### Community 6 - "supabaseService.ts"
Cohesion: 0.08
Nodes (30): createRevisionWorkbookDownload(), buildPlanRecord(), BuildPlanRecordOptions, CreateConversationMessageInput, createPlanChangeProposal(), CreatePlanRevisionInput, createSignedPlanFileDownload(), editablePlanFields (+22 more)

### Community 7 - "devDependencies"
Cohesion: 0.07
Nodes (27): eslint, eslint-config-next, next, dependencies, next, react-dom, devDependencies, eslint (+19 more)
...
Cohesion: 0.12
Nodes (21): Dashboard(), GenerationResult, numberValue(), BulkDeletePlansModal(), BulkDeletePlansModalProps, DeleteOperatorModal(), DeleteOperatorModalProps, DeletePlanModal() (+13 more)
...
Cohesion: 0.14
Nodes (25): adminContext(), applyProposalSchema, createApp(), createMcpServer(), generationInputSchema, planPatchSchema, reviewSchema, sendWorkspaceError() (+17 more)
...
Cohesion: 0.07
Nodes (52): outputPath, proposal, result, bodyFont(), COLORS, DynamicExcelService, safeCellValue(), sectionHeader() (+44 more)

### Community 16 - "applyPlanWorkspaceProposal"
Cohesion: 0.17
Nodes (24): applyPlanWorkspaceProposal(), asProductionPlan(), assistantMessageType(), canAccessPlan(), comparePlanWorkspaceRevisions(), deletePlanWorkspaceRevision(), ensureInitialRevision(), generateRevisionWorkbook() (+16 more)
...
Cohesion: 0.23
Nodes (12): AdminPlanDetailsPanel(), AdminPlanDetailsPanelProps, display(), editableValue(), fileSize(), safeList(), PlanTable(), PlanTableProps (+4 more)

### Community 21 - "login/page.tsx"
Cohesion: 0.21
Nodes (7): Button(), ButtonProps, Spinner(), FormGroup(), FormGroupProps, AuthLayout(), AuthLayoutProps
...
### Community 28 - "Brand.tsx"
Cohesion: 0.28
Nodes (6): LeafLogo(), LeafLogoProps, Brand(), BrandProps, DashboardLayout(), DashboardLayoutProps
...
- **Why does `generateProductionPlan()` connect `plannerService.ts` to `planningConstraintsService.ts`, `whatsappBot.ts`, `supabaseService.ts`, `server.ts`, `dynamicPlanService.ts`, `applyPlanWorkspaceProposal`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `PlanTable()` connect `AdminPlanDetailsPanel.tsx` to `adminTypes.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `react` connect `AdminPlanDetailsPanel.tsx` to `devDependencies`?**
